  ...
  this.Typist = (function (_super) {
        ...
        (function (_this) {
          return function () {
            ...
            return _this.typeText(
              _this.variations[_this.offsets.current.index]
            );
          };
        })(this),
    ...
    Typist.prototype.selectText = function (letter, index) {
      return this._delay(
        (function (_this) {
          return function () {
            return _this.selectOffset(
              _this.offsets.current.text.length - index - 1
            );
          };
        })(this),
    ...
    Typist.prototype.typeLetter = function (letter, index) {
      ...
      if (this.typeTextSplit.length === index + 1) {
        return (this.timer = this._periodical(
          this.slide,
